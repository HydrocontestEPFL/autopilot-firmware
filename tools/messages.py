...
msgdir = os.path.join(os.path.abspath(os.path.dirname(__file__)), '..', 'build', 'messages')
nanopbdir = os.path.join(os.path.abspath(os.path.dirname(__file__)), '..', 'lib', 'nanopb', 'nanopb', 'generator', 'proto')
