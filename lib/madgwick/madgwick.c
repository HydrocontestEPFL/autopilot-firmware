                            ...
                            float mz)
{
    ...
    if (!((ax == 0.0f) && (ay == 0.0f) && (az == 0.0f))) {
        ...
        hx = mx * q0q0 - _2q0my * f->q[3] + _2q0mz * f->q[2] + mx * q1q1 + _2q1 * my * f->q[2]
             + _2q1 * mz * f->q[3] - mx * q2q2 - mx * q3q3;
        hy = _2q0mx * f->q[3] + my * q0q0 - _2q0mz * f->q[1] + _2q1mx * f->q[2] - my * q1q1
             + my * q2q2 + _2q2 * mz * f->q[3] - my * q3q3;
        _2bx = sqrt(hx * hx + hy * hy);
        _2bz = -_2q0mx * f->q[2] + _2q0my * f->q[1] + mz * q0q0 + _2q1mx * f->q[3] - mz * q1q1
               + _2q2 * my * f->q[3] - mz * q2q2 + mz * q3q3;
        _4bx = 2.0f * _2bx;
        _4bz = 2.0f * _2bz;

        // Gradient decent algorithm corrective step
        s0 = -_2q2 * (2.0f * q1q3 - _2q0q2 - ax) + _2q1 * (2.0f * q0q1 + _2q2q3 - ay)
             - _2bz * f->q[2] * (_2bx * (0.5f - q2q2 - q3q3) + _2bz * (q1q3 - q0q2) - mx)
             + (-_2bx * f->q[3] + _2bz * f->q[1]) * (_2bx * (q1q2 - q0q3) + _2bz * (q0q1 + q2q3) - my)
             + _2bx * f->q[2] * (_2bx * (q0q2 + q1q3) + _2bz * (0.5f - q1q1 - q2q2) - mz);
        s1 = _2q3 * (2.0f * q1q3 - _2q0q2 - ax) + _2q0 * (2.0f * q0q1 + _2q2q3 - ay)
             - 4.0f * f->q[1] * (1 - 2.0f * q1q1 - 2.0f * q2q2 - az)
             + _2bz * f->q[3] * (_2bx * (0.5f - q2q2 - q3q3) + _2bz * (q1q3 - q0q2) - mx)
             + (_2bx * f->q[2] + _2bz * f->q[0]) * (_2bx * (q1q2 - q0q3) + _2bz * (q0q1 + q2q3) - my)
             + (_2bx * f->q[3] - _4bz * f->q[1])
                   * (_2bx * (q0q2 + q1q3) + _2bz * (0.5f - q1q1 - q2q2) - mz);
        s2 = -_2q0 * (2.0f * q1q3 - _2q0q2 - ax) + _2q3 * (2.0f * q0q1 + _2q2q3 - ay)
             - 4.0f * f->q[2] * (1 - 2.0f * q1q1 - 2.0f * q2q2 - az)
             + (-_4bx * f->q[2] - _2bz * f->q[0])
                   * (_2bx * (0.5f - q2q2 - q3q3) + _2bz * (q1q3 - q0q2) - mx)
             + (_2bx * f->q[1] + _2bz * f->q[3]) * (_2bx * (q1q2 - q0q3) + _2bz * (q0q1 + q2q3) - my)
             + (_2bx * f->q[0] - _4bz * f->q[2])
                   * (_2bx * (q0q2 + q1q3) + _2bz * (0.5f - q1q1 - q2q2) - mz);
        s3 = _2q1 * (2.0f * q1q3 - _2q0q2 - ax) + _2q2 * (2.0f * q0q1 + _2q2q3 - ay)
             + (-_4bx * f->q[3] + _2bz * f->q[1])
                   * (_2bx * (0.5f - q2q2 - q3q3) + _2bz * (q1q3 - q0q2) - mx)
             + (-_2bx * f->q[0] + _2bz * f->q[2]) * (_2bx * (q1q2 - q0q3) + _2bz * (q0q1 + q2q3) - my)
             + _2bx * f->q[1] * (_2bx * (q0q2 + q1q3) + _2bz * (0.5f - q1q1 - q2q2) - mz);
    ...
    recipNorm = invSqrt(f->q[0] * f->q[0] + f->q[1] * f->q[1] + f->q[2] * f->q[2] + f->q[3] * f->q[3]);
    f->q[0] *= recipNorm;
    f->q[1] *= recipNorm;
    f->q[2] *= recipNorm;
    f->q[3] *= recipNorm;
...
void madgwick_filter_updateIMU(
    madgwick_filter_t *f, float gx, float gy, float gz, float ax, float ay, float az)
{
    float recipNorm;
    float s0, s1, s2, s3;
    float qDot1, qDot2, qDot3, qDot4;
