...
#define ERROR(text, ...)                                                                           \
    do {                                                                                           \
        if (g_error_fct.error) {                                                                   \
            struct error e = error_generate(ERROR_SEVERITY_ERROR, (text), (__FILE__), __LINE__);   \
...
#define WARNING(text, ...)                                                                         \
    do {                                                                                           \
        if (g_error_fct.warning) {                                                                 \
            struct error e = error_generate(ERROR_SEVERITY_WARNING, (text), (__FILE__), __LINE__); \
...
#define NOTICE(text, ...)                                                                          \
    do {                                                                                           \
        if (g_error_fct.notice) {                                                                  \
            struct error e = error_generate(ERROR_SEVERITY_NOTICE, (text), (__FILE__), __LINE__);  \
...
#define DEBUG(text, ...)                                                                           \
    do {                                                                                           \
        if (g_error_fct.debug) {                                                                   \
            struct error e = error_generate(ERROR_SEVERITY_DEBUG, (text), (__FILE__), __LINE__);   \
